...
const AppBar = ({ title,onPress,onPress1,top,left}) => {
  return (
    <View style={{position:"absolute",top:top,left:left}} className={` flex items-center flex-row justify-between w-full`}>
